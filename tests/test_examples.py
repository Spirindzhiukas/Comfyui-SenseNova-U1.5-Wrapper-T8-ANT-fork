...
class ExampleWorkflowTests(unittest.TestCase):
    ...
    def test_frontend_edit_and_multi_reference_contracts(self):
        ...
        self.assertEqual(edit_reference["inputs"][-1]["localized_name"], "reference image")
        self.assertEqual(edit_reference["inputs"][-1]["label"], "reference image")
        ...
        self.assertEqual([value["localized_name"] for value in multi_reference["inputs"][-2:]], ["reference image 1", "reference image 2"])
