...
try:
    import gguf
except ImportError as error:  # CI checks the optional loader when its runtime dep is installed.
    raise unittest.SkipTest("GGUF tests require gguf>=0.13.0") from error
